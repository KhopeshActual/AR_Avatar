Shader "Hidden/.poiyomi/★ Poiyomi Pro ★/White-White"
{
    Properties
    {
        [HideInInspector] shader_is_using_thry_editor ("", Float) = 0
        [HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi Pro V7.3.028</color>", Float) = 0
...
#define PROP_LIGHTINGGRADIENTSTART 0.224
#define PROP_LIGHTINGGRADIENTEND 0.914
...
#define PROP_ENTRANCESTIFFNESS 0
#define PROP_CURVATURE 0
#define PROP_RECURVATURE 0
#define PROP_WRIGGLE 0.28
