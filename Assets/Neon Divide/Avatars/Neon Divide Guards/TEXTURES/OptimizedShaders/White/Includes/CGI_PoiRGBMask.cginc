    ...
    float3 calculateRGBMask(float3 baseColor)
    {
        ...
        {
            float3 RGBColor = 1;
            RGBColor = lerp(RGBColor, red.rgb * float4(1,0.9162945,0.9162945,1).rgb, rgbMask.r * red.a * float4(1,0.9162945,0.9162945,1).a);
        ...
        {
            baseColor = lerp(baseColor, red.rgb * float4(1,0.9162945,0.9162945,1).rgb, rgbMask.r * red.a * float4(1,0.9162945,0.9162945,1).a);
