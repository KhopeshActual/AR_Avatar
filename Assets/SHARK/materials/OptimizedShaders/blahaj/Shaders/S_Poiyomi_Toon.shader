Shader "Hidden/Locked/.poiyomi/• Poiyomi Toon •/blahaj-blahaj"
{
    Properties
    {
...
#define PROP_DETAILNORMALMAPSCALE 0.9
...
#define PROP_RIMWIDTH 0.656
#define PROP_RIMSHARPNESS 0
#define PROP_RIMSTRENGTH 0
#define PROP_RIMBRIGHTEN 2.24
