...
public class PoiMaster : ShaderGUI
{
  private static class Styles
  {
    ...
    public static GUIContent PanosphereEnabled = new GUIContent("panosphere Enabled", "");
  ...
  public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
  {
    ...
    if (m_panoshphereOptions)
    {
      ...
      materialEditor.ShaderProperty(m_panosphereEnabled, Styles.PanosphereEnabled);
