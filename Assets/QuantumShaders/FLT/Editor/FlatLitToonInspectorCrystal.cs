...
public class FlatLitToonInspectorCrystal : ShaderGUI
{
    ...
    MaterialProperty EffectMask;
    MaterialProperty EffectSpeed;
    MaterialProperty EffectSize;
    MaterialProperty GemColor1;
    MaterialProperty GemColor2;
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        { //Find Properties
            ...
            EffectMask = FindProperty("_EffectMask", props);
            EffectSpeed = FindProperty("_EffectSpeed", props);
            EffectSize = FindProperty("_EffectSize", props);
            GemColor1 = FindProperty("_GemColor1", props);
            GemColor2 = FindProperty("_GemColor2", props);
        }
        ...
        { //Shader Properties GUI
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                {// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< CUSTOM
                    GUILayout.Label("____Effect_Settings____", EditorStyles.boldLabel);

                    materialEditor.TexturePropertySingleLine(new GUIContent("Effect Mask", "Effect Mask"), EffectMask);

                    materialEditor.ShaderProperty(EffectSpeed, "Speed", 2);
                    materialEditor.ShaderProperty(EffectSize, "Size", 2);
                    materialEditor.ShaderProperty(GemColor1, "Color 1", 2);
                    materialEditor.ShaderProperty(GemColor2, "Color 2", 2);
                }// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< END
            }
