...
public class FlatLitToonInspectorStars : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        { //Shader Properties GUI
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                {// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< CUSTOM
                    GUILayout.Label("_____Star_Settings_____", EditorStyles.boldLabel);
                    ...
                    EditorGUI.BeginChangeCheck();
                    stLayers = (StarLayers)EditorGUILayout.Popup("Star Layers", (int)stLayers, Enum.GetNames(typeof(StarLayers)));

                    if (EditorGUI.EndChangeCheck()){
                        materialEditor.RegisterPropertyChangeUndo("Star Layers");
