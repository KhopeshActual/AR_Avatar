...
public class FlatLitToonInspectorCutout : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        { //Find Properties
            ...
            EffectAngle = FindProperty("_EffectAngle", props);
        ...
        { //Shader Properties GUI
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                {// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< CUSTOM
                    ...
                    materialEditor.ShaderProperty(EffectAngle, "Angle", 2);
